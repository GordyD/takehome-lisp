...
(defpackage :takehome
  (:use :common-lisp)
  (:export #:tax-bracket #:tax #:ni #:salary)
)
    ...
    (if (< x 41866)
      ...
      (if (< x 100002)
        ...
        (if (< x 120000)
          (let 
            (
              (allowance (- 10000 (/(- x 100000) 2)))
            )
            (+ (* (/ (- 41866 allowance) 100) 20) (* (/ (- x (- 41866 allowance)) 100) 40))
          )
          (if (< x 150000)
            (+ (* (/ 31866 100) 20) (* (/ (- x 31866) 100) 40))
            (+ (* (/ 31866 100) 20) (* (/ 118134 100) 40) (* (/ (- x 150000) 100) 45))
          )
        )
      )
    )
